...
namespace ConsoleApp3
{
    public class Diary
    {
        ...
        public string[] date = new string[Program.init];
        public string[] content = new string[Program.init];
    }
...
internal class Program
{
    ...
    {
        Console.WriteLine("Введите путь до файла (с названием), который вы хотите открыть вася.\r\n---------------------------------------------------------------");
        ...
        Console.WriteLine("Введите кол-во записей в вашем дневнике.Напоминаю их 6 шт.");
